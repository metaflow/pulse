  ...
  if (token.compare("-") != 0) {
    for (auto character : token) {
      ...
      if (castling == Castling::NOCASTLING) {
        ...
        kingFile = Square::getFile(
            Bitboard::next(position.pieces[color][PieceType::KING]));
...
int Notation::toPieceType(char notation) {
  ...
  switch (uppercaseNotation) {
    ...
    default: return PieceType::NOPIECETYPE;
  }
}
...
char Notation::fromPiece(int piece) {
  return transform(fromPieceType(Piece::getType(piece)),
...
int Notation::toCastlingType(char notation) {
  char uppercaseNotation = std::toupper(notation);
  switch (uppercaseNotation) {
    case KINGSIDE_NOTATION: return CastlingType::KINGSIDE;
    case QUEENSIDE_NOTATION: return CastlingType::QUEENSIDE;
    default: return CastlingType::NOCASTLINGTYPE;
  }
}

char Notation::fromCastlingType(int castlingtype) {
  switch (castlingtype) {
    case CastlingType::KINGSIDE: return KINGSIDE_NOTATION;
    case CastlingType::QUEENSIDE: return QUEENSIDE_NOTATION;
...
char Notation::fromCastling(int castling) {
  return transform(fromCastlingType(Castling::getType(castling)),
                   Castling::getColor(castling));
}

int Notation::toFile(char notation) {
  char lowercaseNotation = std::tolower(notation);
  switch (lowercaseNotation) {
    case a_NOTATION: return File::a;
    case b_NOTATION: return File::b;
    case c_NOTATION: return File::c;
    case d_NOTATION: return File::d;
    case e_NOTATION: return File::e;
    case f_NOTATION: return File::f;
    case g_NOTATION: return File::g;
    case h_NOTATION: return File::h;
    default: return File::NOFILE;
  }
}

char Notation::fromFile(int file) {
  switch (file) {
    case File::a: return a_NOTATION;
    case File::b: return b_NOTATION;
    case File::c: return c_NOTATION;
    case File::d: return d_NOTATION;
    case File::e: return e_NOTATION;
    case File::f: return f_NOTATION;
    case File::g: return g_NOTATION;
    case File::h: return h_NOTATION;
    case File::NOFILE:
    default:
      std::cerr << "ERROR " << __FILE__ << ' ' << __LINE__ << std::endl;
      throw std::exception();
...
int Notation::toRank(char notation) {
  switch (notation) {
    case r1_NOTATION: return Rank::r1;
    case r2_NOTATION: return Rank::r2;
    case r3_NOTATION: return Rank::r3;
    case r4_NOTATION: return Rank::r4;
    case r5_NOTATION: return Rank::r5;
    case r6_NOTATION: return Rank::r6;
    case r7_NOTATION: return Rank::r7;
    case r8_NOTATION: return Rank::r8;
    default: return Rank::NORANK;
  }
}

char Notation::fromRank(int rank) {
  switch (rank) {
    case Rank::r1: return r1_NOTATION;
    case Rank::r2: return r2_NOTATION;
    case Rank::r3: return r3_NOTATION;
    case Rank::r4: return r4_NOTATION;
    case Rank::r5: return r5_NOTATION;
    case Rank::r6: return r6_NOTATION;
    case Rank::r7: return r7_NOTATION;
    case Rank::r8: return r8_NOTATION;
    case Rank::NORANK:
    default:
      std::cerr << "ERROR " << __FILE__ << ' ' << __LINE__ << std::endl;
      throw std::exception();
